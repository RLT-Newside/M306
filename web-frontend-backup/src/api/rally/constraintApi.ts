...
import type { Constraint } from '../../models/rally/rally';
import BaseApi from '../baseApi';

class ConstraintApi extends BaseApi {
  public getAll(rallyId: string, rallyStageId: string): Promise<Constraint[]> {
    return this.get<Constraint[]>(`rally/v1/rally/${rallyId}/stage/${rallyStageId}/constraint`)
  ...
  public remove(rallyId: string, rallyStageId: string, constraintId: string): Promise<void> {
