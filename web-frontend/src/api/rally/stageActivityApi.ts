...
class StageActivityApi extends BaseApi {
  ...
  public create(stageId: string, stageActivity: Partial<StageActivity>): Promise<StageActivity> {
  ...
  public update(stageId: string, stageActivity: StageActivity): Promise<StageActivity> {
  ...
  public remove(stageId: string, stageActivityId: string): Promise<void> {
    return this.delete<void>(`rally/v1/stage/${stageId}/activity/${stageActivityId}`)
