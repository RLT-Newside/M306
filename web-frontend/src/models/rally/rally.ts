...
export class Rally {
  ...
  constructor(id: string, title: string, rallyStages: RallyStage[], assignments: Assignment[]) {
    this.id = id;
    this.title = title;
...
export class RallyStage {
  ...
  constructor(id: string, rallyId: string, stageId: string, constraints: Constraint[]) {
    this.id = id;
  ...
  static BuildConstraint(
    ...
    switch (type) {
      ...
      case 'predecessor':
        ...
        return new PredecessorConstraint('', conditions, rallyStageId!, immediate!);
      case 'successor':
...
export class PredecessorConstraint extends Constraint {
  ...
  constructor(id: string, conditions: Condition[], predecessorId: string, immediate: boolean) {
...
export class LocationCondition extends Condition {
  ...
  constructor(id: string, matchingType: ConditionMatchingType, locationId: string) {
...
export class StageCondition extends Condition {
  ...
  constructor(id: string, matchingType: ConditionMatchingType, stageId: string) {
    super(id, matchingType);
    this.stageId = stageId;
  }
}
